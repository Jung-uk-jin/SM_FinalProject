...
<body>
    <!-- 헤더 -->
    <div id="header">
        <a href="/" style="font-size: 30px;">홈 아이콘</a>
    </div>
    ...
    <div class="container">
        ...
        <div id="video-section">
		    ...
		    <h2>콘서트 제목</h2>
		    <!-- 사용자 수 표시 -->
		    <div id="userCount"><img src="images/사람.png" style="width: 25; height: 25; margin-right: 10px; ">
		    <span style="padding-top: 10px; font-size: 28px">${userCount}</span></div>
       </div>

        <!-- 채팅 영역 -->
        <div id="chat-section">
            <div id="chatHeader">채팅방<span style="color: red; padding-left: 200px;">
            	<img src="images/사이렌.png" style="width: 20; height: 20;"> <button onclick="reportBadWord()">신고하기</button></span></div>
	            <div id="chat">
	                <!-- 채팅 메시지가 표시될 영역 -->
	            </div>
