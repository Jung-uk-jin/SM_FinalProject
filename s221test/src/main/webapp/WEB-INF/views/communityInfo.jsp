                      ...
                      <tbody>
	                      <c:if test="${not empty list}">
		              	    <c:forEach items="${list}" var="cdto">
						       <tr>
						         <td>${cdto.community_no}</td>
						         <td>${cdto.community_content}</td>
						         <td>${cdto.community_date}</td>
						         <td>${cdto.community_like }</td>
						         <td><button onclick="deleteBtn(${cdto.community_no})" class="register-button">삭제</button></td>
						       </tr>
						     </c:forEach>
					      </c:if>
