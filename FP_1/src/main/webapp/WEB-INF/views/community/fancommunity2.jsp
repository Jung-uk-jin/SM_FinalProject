...
<body>
	<c:set var="nicknameName" value="${param.nickname_name}" />
	<c:if test="${not empty nicknameName}">
	    <c:set var="session_nickname_name" value="${nicknameName}" scope="session" />
	</c:if>
	
	<script>
	    var currentUserNickname = "${sessionScope.session_nickname_name}";
	    console.log("✅ 팬 커뮤니티 닉네임:", currentUserNickname);
	</script>
    <header>
	        <div id="logo">
