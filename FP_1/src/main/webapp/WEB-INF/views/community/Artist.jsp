	...
	<div id="postModal" class="modal">
	    <div class="modal-content">
	        <form id="nicknameForm">
	            ...
	            <button type="button" class="submit-btn" id="re-btn">등록</button>
	        </form>
	    </div>
	</div>
	                    ...
	                    success: function (response) {
	                        ...
	                        if (response && response.recommendations && Array.isArray(response.recommendations)) {
	                            ...
	                            $.ajax({
	                                ...
	                                contentType: "application/json",
	                                data: JSON.stringify({
	                                    nickname_name: nickname,  // 서버로 전송할 데이터 중 하나 (nickname_name)
	                                    artistDto: { artist_no: artistNo },  // 아티스트 정보 (artist_no)
	                                    memberDto: { member_nickname: memberNickname }  // 회원 정보 (member_nickname)
	                                }),
	                                success: function (response) {
	                                    if (response.success) {
