              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                  	<form action="/awrite" name="writeFrm" method="post" enctype="multipart/form-data">
                    <table
                      id="zero_config"
                    ...
                    >
                      ...
                      <tbody>
						<tr>
							<th>아티스트명</th>
							<td>
								<input type="text" name="artist_group_name"  class="name" style="width:300px; height:30px;">
							</td>
						</tr>
						<tr>
							<th>아티스트 정보</th>
					...
					<button type="button" onclick="location.href='/aartistlist'" class="register-button">취소</button>
                  </div>
                </div>
              </div>
            </div>
