	    ...
	    <main>
	        ...
	        <c:if test="${session_id!=null}">
				    ...
				    <div class="myC">
				        ...
				        <div class="community-container">
				            <c:forEach var="n" items="${nlist}">
				                <a href="/fancommunity?artist_no=${n.artistDto.artist_no}&nickname_name=${n.nickname_name}">
		        ...
		        <section class="merch">
				    <h2>Merch</h2>
				    <c:forEach var="n" items="${nlist}">
				   		<a><div class="idolMerch">${n.artistDto.artist_group_name}</div></a>
				    </c:forEach>
			    ...
			    <table class="artist-table">
			        <tbody>
			            <c:forEach items="${list}" var="adto" varStatus="status">
							...
							<c:if test="${not empty nlist}">
			                <td>
			                	<a href="/fancommunity?artist_no=${adto.artist_no}&nickname_name=${sessionScope.session_nickname_name}"">
			                    <div class="artist-card">
			                       	<img src="images/${adto.artist_group_image }" alt="Artist"> 
			                        <div class="artist-name">${adto.artist_group_name}</div>
			                    </div>
