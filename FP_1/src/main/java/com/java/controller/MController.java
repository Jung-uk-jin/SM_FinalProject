...
//	    NicknameDto nicknameDto = nicknameService.findByMemberId(id);
...
//	    session.setAttribute("session_nickname_name", nicknameDto.getNickname_name()); // 커뮤니티 닉네임 저장
//	    System.out.println("커뮤니티 닉네임 : "+ nicknameDto.getNickname_name());
	...
	public String cart(Model model) {
	    ...
	    if (id != null) {
	        MemberDto memberdto = mService.findById(id);
	        List<AddressDto> aList = addressService.findByMemberId(id);
	        List<CartDto> cList = cartservice.findByMemberId(id);
